...
const handleRegister = () => {
  ...
  if (
    registerForm.value.jf &&
    !context?.$toolUtil.isNumber(registerForm.value.jf)
  ) {
...
.register_view {
  ...
  background: url(http://localhost:8080/sportSystem/file/67e7bc0be6f14fe6964350c99487b3c7.jpg);
  display: flex;
  min-height: 100vh;
  ...
  .register_form {
    ...
    padding: 0 0 0 600px;
    margin: 0;
    background: url(http://localhost:8080/sportSystem/file/5333a9813e004bb8a7463aa34fcb11e1.jpg)
