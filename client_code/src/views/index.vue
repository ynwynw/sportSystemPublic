<template>
  <div class="home">
    <div class="index_top">
      <div class="index_top_title">体育平台网站</div>
...
.index_top {
  ...
  z-index: 1002;
  color: #fff;
  background: url(http://localhost:8080/sportSystem/file/98766058521b4a04a01a70fe9b14b6b4.jpg)
      repeat-x center top,
    #fff;
  display: block;
  width: 100%;
...
.menu_scrollbar {
  ...
  padding: 0;
  margin: 16px auto 0;
  background: url(http://localhost:8080/sportSystem/file/dd687dc1ffd944c5ad2c38d477f86ebc.jpg)
    repeat-x center top;
  width: 64%;
  border-color: #efefef;
...
.menu_view {
  ...
  :deep(.is-active) {
    color: #fff !important;
    background: url(http://localhost:8080/sportSystem/file/211a1c936aff44009a17016e8cd0eeaf.jpg)
